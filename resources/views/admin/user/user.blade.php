            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="{{url('admin/images/blog/'.Auth::user() -> avatar)}}" class="rounded-circle" width="150" />
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                ...
                                <h6>{{Auth::user() -> phone}}</h6> <small class="text-muted p-t-30 db">Country</small>
                            ...
                            <div class="alert alert-success alert-dismissible">
                                ...
                                <form method="post" class="form-horizontal form-material" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="email" disabled  value="{{Auth::user() -> email}}" class="form-control form-control-line" name="email" id="example-email">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Password</label>
                                        <div class="col-md-12">
                                            <input type="password" placeholder="********" value="" class="form-control form-control-line" name="password">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12">Avarta</label>
                                        <div class="col-md-12">
